...
public class InputManagerScript : MonoBehaviour {
	...
	private CharacterScript script1, script2;
	...
	void Start () {
		...
		script1 = player1.GetComponent("CharacterScript") as CharacterScript; //gestion mouvement joueur 1
		script2 = player2.GetComponent("CharacterScript") as CharacterScript; //gestion mouvement joueur 2
